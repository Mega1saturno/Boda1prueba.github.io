...
document.getElementById("confirmarNovia").addEventListener("click", function () {
    const mensaje = "¡Hola Dulce! Confirmo mi asistencia a la boda. ¡Es un honor poder acompañarlos en este día tan especial!";
...
document.getElementById("confirmarNovio").addEventListener("click", function () {
    const mensaje = "¡Hola Erick! Confirmo mi asistencia a la boda. ¡Es un honor poder acompañarlos en este día tan especial!";
